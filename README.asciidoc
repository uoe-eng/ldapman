...
+ldapman+ has a simlpe configuration file, which allows you to define default OUs within your ldap infrastructure for common types - users, groups, netgroups, etc.  This allows you to create, modify and remove objects without having to specify full DNs.
